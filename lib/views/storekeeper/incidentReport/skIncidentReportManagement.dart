...
import 'package:ui_fresh_app/views/storekeeper/incidentReport/skIncidentReportCreating.dart';
import 'package:ui_fresh_app/views/storekeeper/incidentReport/skSearchingIncidentReport.dart';
...
class skIncidentReportManagementScreen extends StatefulWidget {
  const skIncidentReportManagementScreen({Key? key}) : super(key: key);

  @override
  State<skIncidentReportManagementScreen> createState() => _skIncidentReportManagementScreenState();
}

class _skIncidentReportManagementScreenState extends State<skIncidentReportManagementScreen>
