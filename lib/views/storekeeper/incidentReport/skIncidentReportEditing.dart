...
class skIncidentReportEditingScreen extends StatefulWidget {
  skIncidentReportEditingScreen({Key? key}) : super(key: key);

  @override
  _skIncidentReportEditingScreenState createState() =>
      _skIncidentReportEditingScreenState();
}

class _skIncidentReportEditingScreenState
    extends State<skIncidentReportEditingScreen> with InputValidationMixin{
