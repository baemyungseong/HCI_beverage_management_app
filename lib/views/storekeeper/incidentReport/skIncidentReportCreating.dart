...
class skIncidentReportCreatingScreen extends StatefulWidget {
  skIncidentReportCreatingScreen({Key? key}) : super(key: key);

  @override
  _skIncidentReportCreatingScreenState createState() =>
      _skIncidentReportCreatingScreenState();
}

class _skIncidentReportCreatingScreenState
    extends State<skIncidentReportCreatingScreen> with InputValidationMixin {
