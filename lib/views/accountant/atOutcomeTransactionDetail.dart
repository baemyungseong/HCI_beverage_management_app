...
class atOutcomeTransactionDetailScreen extends StatefulWidget {
  const atOutcomeTransactionDetailScreen({Key? key}) : super(key: key);

  @override
  _atOutcomeTransactionDetailScreenState createState() =>
      _atOutcomeTransactionDetailScreenState();
}

class _atOutcomeTransactionDetailScreenState
    extends State<atOutcomeTransactionDetailScreen> with InputValidationMixin {
