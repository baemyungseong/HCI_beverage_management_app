...
class atIncidentReportCreatingScreen extends StatefulWidget {
  atIncidentReportCreatingScreen({Key? key}) : super(key: key);

  @override
  _atIncidentReportCreatingScreenState createState() =>
      _atIncidentReportCreatingScreenState();
}

class _atIncidentReportCreatingScreenState
    extends State<atIncidentReportCreatingScreen> with InputValidationMixin {
