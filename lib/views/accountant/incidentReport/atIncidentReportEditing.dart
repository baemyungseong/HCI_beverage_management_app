...
class atIncidentReportEditingScreen extends StatefulWidget {
  atIncidentReportEditingScreen({Key? key}) : super(key: key);

  @override
  _atIncidentReportEditingScreenState createState() =>
      _atIncidentReportEditingScreenState();
}

class _atIncidentReportEditingScreenState
    extends State<atIncidentReportEditingScreen> with InputValidationMixin {
