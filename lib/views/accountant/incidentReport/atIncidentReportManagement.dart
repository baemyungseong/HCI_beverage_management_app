...
import 'package:ui_fresh_app/views/accountant/incidentReport/atSearchingIncidentReport.dart';
import 'package:ui_fresh_app/views/accountant/atWidget/atTabView.dart';
import 'package:ui_fresh_app/views/accountant/incidentReport/atIncidentReportCreating.dart';
...
class atIncidentReportManagementScreen extends StatefulWidget {
  const atIncidentReportManagementScreen({Key? key}) : super(key: key);

  @override
  State<atIncidentReportManagementScreen> createState() => _atIncidentReportManagementScreenState();
}

class _atIncidentReportManagementScreenState extends State<atIncidentReportManagementScreen>
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    atIncidentReportCreatingScreen(),
                              ),
                            );
                          },
                          child: AnimatedContainer(
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onEditingComplete: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  atIncidentReportSearchingScreen(
