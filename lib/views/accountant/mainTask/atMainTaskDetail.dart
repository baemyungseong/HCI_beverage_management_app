...
class atMaintaskDetailScreen extends StatefulWidget {
  atMaintaskDetailScreen({Key? key}) : super(key: key);

  @override
  _atMaintaskDetailScreenState createState() => _atMaintaskDetailScreenState();
}

class _atMaintaskDetailScreenState
    extends State<atMaintaskDetailScreen> {
