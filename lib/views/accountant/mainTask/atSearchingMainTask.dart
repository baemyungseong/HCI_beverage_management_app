...
//import views
import 'package:ui_fresh_app/views/accountant/mainTask/atMainTaskDetail.dart';
...
class atMainTaskSearchingScreen extends StatefulWidget {

  atMainTaskSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _atMainTaskSearchingScreenState createState() => _atMainTaskSearchingScreenState();
}

class _atMainTaskSearchingScreenState extends State<atMainTaskSearchingScreen> {
