...
class atTabViewWidget extends StatefulWidget {
  const atTabViewWidget({Key? key}) : super(key: key);

  @override
  State<atTabViewWidget> createState() => _atTabViewWidgetState();
}

class _atTabViewWidgetState extends State<atTabViewWidget>
