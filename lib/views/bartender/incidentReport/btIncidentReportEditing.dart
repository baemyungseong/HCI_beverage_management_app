...
class btIncidentReportEditingScreen extends StatefulWidget {
  btIncidentReportEditingScreen({Key? key}) : super(key: key);

  @override
  _btIncidentReportEditingScreenState createState() =>
      _btIncidentReportEditingScreenState();
}

class _btIncidentReportEditingScreenState
    extends State<btIncidentReportEditingScreen> with InputValidationMixin {
