...
class btMainTaskSearchingScreen extends StatefulWidget {

  btMainTaskSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _btMainTaskSearchingScreenState createState() => _btMainTaskSearchingScreenState();
}

class _btMainTaskSearchingScreenState extends State<btMainTaskSearchingScreen> {
