...
class btDashboardSearchingScreen extends StatefulWidget {

  btDashboardSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _btDashboardSearchingScreenState createState() => _btDashboardSearchingScreenState();
}

class _btDashboardSearchingScreenState extends State<btDashboardSearchingScreen> {
