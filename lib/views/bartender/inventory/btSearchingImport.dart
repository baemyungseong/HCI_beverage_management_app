...
class btImportSearchingScreen extends StatefulWidget {

  btImportSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _btImportSearchingScreenState createState() => _btImportSearchingScreenState();
}

class _btImportSearchingScreenState extends State<btImportSearchingScreen> {
                                ...
                                return GestureDetector(
                                  onTap: () {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => btImportDetailScreen(),
                                      ),
                                    );
                                    // .then((value) {});
                                  },
                                  child: AnimatedContainer(
                                    ...
                                    child: Row(
                                      children: [
                                        Image.asset('assets/images/accountant/oderavatar.png',
                                        ),
                                        SizedBox(width: 16),
                                        Container(
                                          child: Column(
