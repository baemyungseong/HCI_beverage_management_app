...
import 'package:ui_fresh_app/views/bartender/dashboard/btDrinkChoosing.dart';
...
class btDashboardManagementSearchingScreen extends StatefulWidget {

  btDashboardManagementSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _btDashboardManagementSearchingScreenState createState() => _btDashboardManagementSearchingScreenState();
}

class _btDashboardManagementSearchingScreenState extends State<btDashboardManagementSearchingScreen> {
