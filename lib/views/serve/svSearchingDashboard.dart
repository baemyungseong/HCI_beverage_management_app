...
class svDashboardCenterSearchScreen extends StatefulWidget {

  svDashboardCenterSearchScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _svDashboardCenterSearchScreenState createState() => _svDashboardCenterSearchScreenState();
}

class _svDashboardCenterSearchScreenState extends State<svDashboardCenterSearchScreen> {
