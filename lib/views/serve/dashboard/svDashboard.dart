...
import 'package:ui_fresh_app/views/serve/dashboard/svDrinkCart.dart';
import 'package:ui_fresh_app/views/serve/dashboard/svSearchingDashboard.dart';
...
class svDashboardManagementScreen extends StatefulWidget {
  const svDashboardManagementScreen({Key? key}) : super(key: key);

  @override
  State<svDashboardManagementScreen> createState() => _svDashboardManagementScreenState();
}

class _svDashboardManagementScreenState extends State<svDashboardManagementScreen>  with SingleTickerProviderStateMixin {
                        ...
                        Container(
                          ...
                          child: TextFormField(
                            ...
                            onEditingComplete: () => Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    svDashboardManagementSearchingScreen(
