...
class svInvoiceSearchingScreen extends StatefulWidget {

  svInvoiceSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _svInvoiceSearchingScreenState createState() => _svInvoiceSearchingScreenState();
}

class _svInvoiceSearchingScreenState extends State<svInvoiceSearchingScreen> {
