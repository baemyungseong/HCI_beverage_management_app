...
import 'package:ui_fresh_app/views/serve/svSearchingDashboard.dart';
import 'package:ui_fresh_app/views/serve/svDrinkChosing.dart';
...
class svDashboardCenterScreen extends StatefulWidget {
  const svDashboardCenterScreen({Key? key}) : super(key: key);

  @override
  State<svDashboardCenterScreen> createState() => _svDashboardCenterScreenState();
}

class _svDashboardCenterScreenState extends State<svDashboardCenterScreen>  with SingleTickerProviderStateMixin {
