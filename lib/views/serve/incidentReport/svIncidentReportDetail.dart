...
//import views
import 'package:ui_fresh_app/views/serve/incidentReport/svIncidentReportEditing.dart';
...
class svIncidentReportDetailScreen extends StatefulWidget {
  svIncidentReportDetailScreen({Key? key}) : super(key: key);

  @override
  _svIncidentReportDetailScreenState createState() =>
      _svIncidentReportDetailScreenState();
}

class _svIncidentReportDetailScreenState
    extends State<svIncidentReportDetailScreen> {
