...
class svIncidentReportCreatingScreen extends StatefulWidget {
  svIncidentReportCreatingScreen({Key? key}) : super(key: key);

  @override
  _svIncidentReportCreatingScreenState createState() =>
      _svIncidentReportCreatingScreenState();
}

class _svIncidentReportCreatingScreenState extends State<svIncidentReportCreatingScreen> with InputValidationMixin {
