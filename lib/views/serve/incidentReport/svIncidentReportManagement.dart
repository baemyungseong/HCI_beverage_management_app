...
import 'package:ui_fresh_app/views/serve/incidentReport/svSearchingIncidentReport.dart';
import 'package:ui_fresh_app/views/serve/svWidget/svTabView.dart';
import 'package:ui_fresh_app/views/serve/incidentReport/svIncidentReportCreating.dart';
...
class svIncidentReportManagementScreen extends StatefulWidget {
  const svIncidentReportManagementScreen({Key? key}) : super(key: key);

  @override
  State<svIncidentReportManagementScreen> createState() => _svIncidentReportManagementScreenState();
}

class _svIncidentReportManagementScreenState extends State<svIncidentReportManagementScreen>
                        ...
                        child: GestureDetector(
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) =>
                                    svIncidentReportCreatingScreen(),
                              ),
                            );
                          },
                          child: AnimatedContainer(
                      ...
                      Container(
                        ...
                        child: TextFormField(
                          ...
                          onEditingComplete: () => Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  svIncidentReportSearchingScreen(
