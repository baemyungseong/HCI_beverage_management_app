...
class svMainTaskSearchingScreen extends StatefulWidget {

  svMainTaskSearchingScreen({Key? key, required this.searchResult, required this.haveFilter}) : super(key: key);
  String searchResult;
  bool haveFilter;

  @override
  _svMainTaskSearchingScreenState createState() => _svMainTaskSearchingScreenState();
}

class _svMainTaskSearchingScreenState extends State<svMainTaskSearchingScreen> {
